...
#ifndef STX_BLINDI_BTREE_MULTIMAP_H_HEADER
#define STX_BLINDI_BTREE_MULTIMAP_H_HEADER
...
public:
    ...
    /// Fourth template parameter: Key extractor for blindI
    typedef _KeyExtractor key_extractor_type;

    /// Fifth template parameter:  Key serializer for blindI
    typedef _KeySerializer key_serializer_type;

    /// Sixth template parameter: Traits object used to define more parameters
    /// of the B+ tree
    typedef _Traits traits;

    /// Seventh template parameter: STL allocator
...
public:
    ...
    typedef btree_multimap<key_type, data_type, key_extractor_type, key_serializer_type, key_compare, traits, allocator_type> self_type;
    ...
    typedef stx_blindi::btree<key_type, data_type, key_extractor_type, key_serializer_type, value_type, key_compare,
...
public:
    ...
    /// comparison function
    explicit inline btree_multimap(key_extractor_type key_extractor,
                                   key_serializer_type key_serializer,
                                   const allocator_type& alloc = allocator_type())
        : tree(key_extractor, key_serializer, alloc)
    { }
    ...
    explicit inline btree_multimap(const key_compare& kcf,
                                   ...
                                   key_serializer_type key_serializer)
        : tree(kcf, alloc, key_extractor, key_serializer)
    { }
    ...
    inline btree_multimap(InputIterator first, InputIterator last,
        ...
        : tree(first, last, key_extractor, key_serializer,alloc)
    { }
...
public:
    ...
    inline int64_t theoretic_size() const{
        return tree.get_theoretic_size();
    }
    ...
    inline int64_t get_inner_node_size() const{
        return tree.get_inner_node_size();
    }

    inline int get_inner_node_item_count() const{
        return tree.get_inner_node_item_count();
    }
    inline int get_leaf_item_count() const{
        return tree.get_leaf_item_count();
    }
    inline int64_t get_key_size() const{
        return tree.get_key_size();
    }
...
#endif // !STX_BLINDI_BTREE_MULTIMAP_H_HEADER
