...
#ifndef STX_BLINDI_BTREE_MAP_H_HEADER
#define STX_BLINDI_BTREE_MAP_H_HEADER
...
public:
    ...
    typedef btree_map<key_type, data_type, key_extractor_type, key_serializer_type, key_compare, traits, allocator_type> self_type;
...
public:
    ...
    /// comparison function
    explicit inline btree_map(key_extractor_type key_extractor,
...
#endif // !STX_BLINDI_BTREE_MAP_H_HEADER
